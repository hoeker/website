...
<form name="organise" action="profile.php" method="post" id="editableForm" class="uneditable">
...
<input type="email" name="email" value="joe@example.com" /><br/>
Phone: <span class="editfield" name="phone">416-555-1234</span>
<input type="text" name="phone" "416-555-1234" /><br/>
